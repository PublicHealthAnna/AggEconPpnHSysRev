#------------------------------------------------------------------------------#
#------------------------------------------------------------------------------#
#####                Aggregate Economic Activity Systematic Review         #####
#####          Forest and Funnel plots (Andy PUlford's code adapted        #####
#------------------------------------------------------------------------------#
#------------------------------------------------------------------------------#
...
#### load data -------
# binary outcomes
aea_health_plot <- read.csv("./data/working/ma_bin.csv") %>% 
...
# continuous outcomes
ma_cont <- read.csv("C:\Users\georgr07\Desktop\Economy and health\AEA review\synthesis\
                    AE_ to_Health_for_direction_plot.csv") %>% 
